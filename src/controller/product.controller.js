...
const getProductById = async (req, res) => {
  try {
    ...
    const product = await Items.findOne({ id: productID }).populate('uploadedBy');
...
const getProductsByCategory = async (req, res) => {
  try {
      ...
      const products = await Items.find({ category: category }, '-_id id image product category price specifications keySpecifications');
...
const getProductByUser = async (req, res) => {
  try {
    ...
    // Find the product and populate the 'uploadedBy' field
    const product = await Items.find({ uploadedBy: userID }).populate('uploadedBy');
