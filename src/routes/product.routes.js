...
const { uploadProduct, getProducts, deleteProduct, createReview, getReviews, getProductById, getProductByUser, getProductsByCategory } = require("../controller/product.controller");
